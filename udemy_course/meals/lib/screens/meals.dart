...
class MealsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget content = ListView.builder(
      ...
      itemBuilder: (ctx, index) => MealItem(meal: meals[index], onSelectedMeal: () => _selectedMeal(context, meals[index])
      )
    );

    if (meals.isEmpty) {
      content = Center(child: Column(mainAxisSize: MainAxisSize.min, children: [
        Text("Nothing to show here...", style: Theme.of(context).textTheme.headlineLarge!.copyWith(color: Theme.of(context).colorScheme.onBackground),),
